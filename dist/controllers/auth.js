    ...
    try {
        ...
        if (user) {
            ...
            try {
                ...
                (0, SharedFunctions_1.successfulRequest)(response, "Reset Email Successful", "Password Reset Successful. Check Email For Next Steps", user);
            }
            catch (error) {
            ...
            (0, SharedFunctions_1.failedRequest)(response, "Unable To Locate User By Email", "No Account Found With That Email", "Failed To Reset Password");
        }
    }
    catch (error) {
